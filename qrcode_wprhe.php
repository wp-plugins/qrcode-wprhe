...
/* Shortcode  function */
  function qrcode_wprhe_shortcode($atts) {
	...
	if (empty($alt) && $alt !==0) {
	  ...
	  $credit_footer='<br><a href="http://www.free-qr-code.net" title="Generate your own qr code" target="blank" style="display:block;"><img src="' . plugins_url( $path, $plugin ) . '/qrcode-wprhe/made_with_love.png" border="0" title="Generated by free-qr-code.net" alt="made with love"></a></div>';
	} else {
	  $credit_footer = "";
        }
