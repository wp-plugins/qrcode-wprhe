...
Wordpress plugin to insert a QR code in your blog. The qr code contains current URL or any other text you wish to.
...
* Use the fullowing short code to generate a indivdual qr code with any text content:
  ...
  [qrcode content="CONTENT" size="80" alt="ALT_TEXT" class="CLASS_NAME"] 
